    ...
    myBot.message.add({ // show a message
      ...
      switch (res.value) {
        ...
        case 'your contacts':
          ...
          delay: 1000,
          loading: true,
          content: `Go ahead, try [my website](http://z2care.github.io) or <a href="mailto:z2care@gmail.com">Email me.</a> </br>
                    Here is my [Github address](https://github.com/z2care).`
        });
        break;/*
        case 'your hobbies':
          return myBot.message.add ({
